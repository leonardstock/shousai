        ...
        <div className='max-w-4xl mx-auto px-6 py-16 text-gray-800'>
            ...
            <div className='space-y-6'>
                ...
                <p>
                    ...
                    Legal Terms are posted. The Services are intended for users
                    who are at least 18 years old. Persons under the age of 18
                    are not permitted to use or register for the Services. We
                    recommend that you print a copy of these Legal Terms for
                    your records.
                </p>
                ...
                <p>
                    Our intellectual property We are the owner or the licensee
                    of all intellectual property rights in our Services,
                    including all source code, databases, functionality,
                    ...
                    are provided in or through the Services &apos;AS IS&apos;
                    for your personal, non-commercial use or internal business
                    purpose only. Your use of our Services Subject to your
                    compliance with these Legal Terms, including the
                    &apos;PROHIBITED ACTIVITIES&apos; section below, we grant
                    you a non-exclusive, non-transferable, revocable licence to:
                    <br />• access the Services; and
                    <br />• download or print a copy of any portion of the
                    ...
                    address your request to: support(at)shousai.co.uk. If we
                    ...
                    us all intellectual property rights in such Submission. You
                    agree that we shall own this Submission and be entitled to
                    its unrestricted use and dissemination for any lawful
                    purpose, commercial or otherwise, without acknowledgment or
                    compensation to you. You are responsible for what you post
                    or upload: <br />
                    By sending us Submissions through any part of the Services
                    you: <br />• confirm that you have read and agree with our
                    ...
                    <br />• to the extent permissible by applicable law, waive
                    any and all moral rights to any such Submission; <br />•
                    ...
                    <br />• warrant and represent that your Submissions do not
                    constitute confidential information. You are solely
                    ...
                    party&apos;s intellectual property rights, or (c) applicable
                    law.
                </p>
                <h2 className='text-xl font-semibold'>
                ...
                <p>
                    We accept the following forms of payment: <br />- Visa
                    <br />- Mastercard <br />- American Express
                    <br /> - Discover <br />- PayPal
                    <br /> You agree to provide current, complete, and accurate
                    ...
                    payments shall be in GBP. You agree to pay all charges at
                    the prices then in effect for your purchases and any
                    applicable shipping fees, and you authorise us to charge
                    ...
                    or prohibit orders that, in our sole judgement, appear to be
                    placed by dealers, resellers, or distributors.
                </p>
                <h2 className='text-xl font-semibold'>6. SUBSCRIPTIONS</h2>
                <h3 className='text-lg'>Billing and Renewal</h3>
                ...
                Services, please email us at support(at)shousai.co.uk.
                <h3 className='text-lg'>Fee Changes</h3>
                ...
                <p>
                    ...
                    <br />• Systematically retrieve data or other content from
                    the Services to create or compile, directly or indirectly, a
                    collection, compilation, database, or directory without
                    written permission from us. <br />• Trick, defraud, or
                    ...
                    <br /> • Disparage, tarnish, or otherwise harm, in our
                    opinion, us and/or the Services.
                    <br /> • Use any information obtained from the Services in
                    ...
                    <br /> • Use the Services in a manner inconsistent with any
                    applicable laws or regulations.
                    <br /> • Engage in unauthorised framing of or linking to the
                    Services.
                    ...
                    <br /> • Engage in any automated use of the system, such as
                    using scripts to send comments or messages, or using any
                    data mining, robots, or similar data gathering and
                    extraction tools.
                    <br /> • Delete the copyright or other proprietary rights
                    notice from any Content.
                    <br /> • Attempt to impersonate another user or person or
                    ...
                    <br /> • Use a buying agent or purchasing agent to make
                    purchases on the Services.
                    <br /> • Make any unauthorised use of the Services,
                    ...
                    <br /> • Use the Services as part of any effort to compete
                    with us or otherwise use the Services and/or the Content for
                    any revenue-generating endeavour or commercial enterprise.
                    <br /> • Use the Services to advertise or offer to sell
                    goods and services.
                ...
                <p>
                    ...
                    Policy.
                    <br /> When you create or make available any Contributions,
                    you thereby represent and warrant that:
                    <br /> • The creation, distribution, transmission, public
                    ...
                    <br /> • Your Contributions are not false, inaccurate, or
                    misleading.
                    <br /> • Your Contributions are not unsolicited or
                    unauthorised advertising, promotional materials, pyramid
                    schemes, chain letters, spam, mass mailings, or other forms
                    of solicitation.
                    <br /> • Your Contributions are not obscene, lewd,
                    lascivious, filthy, violent, harassing, libellous,
                    slanderous, or otherwise objectionable (as determined by
                    us).
                    <br /> • Your Contributions do not ridicule, mock,
                    disparage, intimidate, or abuse anyone.
                    <br /> • Your Contributions are not used to harass or
                    threaten (in the legal sense of those terms) any other
                    person and to promote violence against a specific person or
                    class of people.
                    <br /> • Your Contributions do not violate any applicable
                    law, regulation, or rule.
                    <br /> • Your Contributions do not violate the privacy or
                    publicity rights of any third party.
                    <br /> • Your Contributions do not violate any applicable
                    law concerning child pornography, or otherwise intended to
                    protect the health or well-being of minors.
                    <br /> • Your Contributions do not include any offensive
                    comments that are connected to race, national origin,
                    gender, sexual preference, or physical handicap.
                    <br /> • Your Contributions do not otherwise violate, or
                    link to material that violates, any provision of these Legal
                    Terms, or any applicable law or regulation. Any use of the
                    Services in violation of the foregoing violates these Legal
                ...
                <p>
                    ...
                    feedback regarding the Services, you agree that we can use
                ...
                <p>
                    ...
                    available through, or installed from the Services, including
                ...
                <h2 className='text-xl font-semibold'>12. PRIVACY POLICY</h2>
                <p>
                    We care about data privacy and security. Please review our
                    Privacy Policy:{" "}
                    <a href='https://www.shousai.co.uk/privacy'>
                        shousai.co.uk/privacy
                    </a>
                    . <br />
                    By using the Services, you agree to be bound by our Privacy
                    Policy, which is incorporated into these Legal Terms. Please
                    be advised the Services are hosted in the United Kingdom. If
                    you access the Services from any other region of the world
                    with laws or other requirements goveming personal data
                    collection, use, or disclosure that differ from applicable
                    laws in the United Kingdom, then through your continued use
                    of the Services, you are transferring your data to the
                ...
                <p>
                    ...
                    provisions of the law in your country to residence. Shousai
                    Ltd. and yourself both agree to submit to the non-exclusive
                    jurisdiction of the courts of London, which means that you
                    may make a claim to defend your consumer protection rights
                    in regards to these Legal Terms in the United Kingdom, or in
                ...
                <h2 className='text-xl font-semibold'>17. CORRECTIONS</h2>
                <p>
                ...
                <h2 className='text-xl font-semibold'>18. DISCLAIMER</h2>
                <p>
                ...
                <p>
                    ...
                    CONTAINED HEREIN, OUR UABIUTY TO YOU FOR ANY CAUSE
                    ...
                    DO NOT ALLOW UMITATIONS ON IMPLIED WARRANTIES OR THE
                    EXCLUSION OR UMITATION OF CERTAIN DAMAGES. IF THESE LAWS
                    APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR
                    LIMITATIONS MAY NOT APPLY TO YOU. AND YOU MAY HAVE
                    ADDITIONAL RIGHTS.
                </p>
                <h2 className='text-xl font-semibold'>20. INDEMNIFICATION</h2>
                <p>
                    ...
                    this indemnification upon becoming aware of
                </p>
                <h2 className='text-xl font-semibold'>21. USER DATA</h2>
                <p>
                ...
                <h2 className='text-xl font-semibold'>24. MISCELLANEOUS</h2>
                <p>
                ...
                <h2 className='text-xl font-semibold'>25. CONTACT US</h2>
                <p>
                    In order to resolve a complaint regarding the Services or to
                    receive further information regarding use of the Services,
                    please contact us at support(at)shousai.co.uk
                </p>
            </div>
        </div>
    );
